...
namespace Web
{
    ...
    public class WeavingOrderWizardHandloomController : System.Web.Mvc.Controller
    {
        ...
        public ActionResult ConfirmProdOrderList(List<WeavingOrderWizardViewModel> Selected)
        {
            ...
            if (!BarCodesBased)
                return Json(new { Success = "URL", Data = "/WeavingOrderWizardHandloom/Create" }, JsonRequestBehavior.AllowGet);
            else
                return Json(new { Success = "URL", Data = "/WeavingOrderWizardHandloom/FirstBarCode" }, JsonRequestBehavior.AllowGet);
        }
