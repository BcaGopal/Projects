...
function DrawFooterFields(DebugMode) {
    ...
    for (var i = 0; i < FooterFields.length; i++) {
        ...
        temp += "<input type='hidden' id='CALH_" + FooterFields[i].ChargeCode + "ACCR' value='" + (FooterFields[i].LedgerAccountCrId == null ? "" : FooterFields[i].LedgerAccountCrId) + "'  name='linecharges[" + i + "].LedgerAccountCrId'/>"
        temp += "<input type='hidden' id='CALH_" + FooterFields[i].ChargeCode + "ACDR' value='" + (FooterFields[i].LedgerAccountDrId == null ? "" : FooterFields[i].LedgerAccountDrId) + "'  name='linecharges[" + i + "].LedgerAccountDrId'/>"
        temp += "<input type='hidden' id='CALH_" + FooterFields[i].ChargeCode + "CLAC' value='" + (FooterFields[i].ContraLedgerAccountId == null ? "" : FooterFields[i].ContraLedgerAccountId) + "'  name='linecharges[" + i + "].ContraLedgerAccountId'/>"
