    ...
    {               
        ...
        public ActionResult Index(int id, string IndexType)//DocumentTypeId
       {
        ...
        public ActionResult BarcodePrint(int id)
        {
            ...
            return Redirect((string)System.Configuration.ConfigurationManager.AppSettings["CustomizeDomain"] + "/Report_BarcodePrint/PrintBarCode/?GenHeaderId=" + id + "&queryString=" + id);
        }
