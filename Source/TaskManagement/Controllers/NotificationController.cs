...
namespace Web
{
    ...
    { 
        ...
        //public static void CreateNotification(Notification Notification, string UserName)
        //{

        //    using (NotificationApplicationDbContext context=new NotificationApplicationDbContext())
        //    {
        //        Notification.ObjectState = Model.ObjectState.Added;
        //        context.Notification.Add(Notification);

        //        NotificationUser User = new NotificationUser();
        //        User.NotificationId = Notification.NotificationId;
