...
namespace Web
{
    ...
    public class ProductUidHeaderController : System.Web.Mvc.Controller
    {
        ...
        public ActionResult Print(int id)
        {
            ...
            return Redirect((string)System.Configuration.ConfigurationManager.AppSettings["CustomizeDomain"] + "/Report_BarcodePrint/PrintBarCode/?GenHeaderId=" + GenHeaderId);
        }
        ...
        public ActionResult PrintSeries()
        {
            ...
            return Redirect((string)System.Configuration.ConfigurationManager.AppSettings["CustomizeDomain"] + "/Report_BarcodePrint/PrintBarCode/?GenHeaderId=" + ProductUidHeaderIdStr);
        }
        ...
        {
            List<LastValues> LastValuesJson = new List<LastValues>();
            ...
            LastValues temp = (from H in context.ProductUidHeader
            ...
            LastValuesJson.Add(temp);

            return Json(LastValuesJson);
        }
