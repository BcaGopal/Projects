...
namespace Web
{
    ...
    public class SaleOrderHeaderController : System.Web.Mvc.Controller
    {
        ...
        public ActionResult Create(int id)
        {
            ...
            SaleOrderSettings temp = new SaleOrderSettingsService(_unitOfWork).GetSaleOrderSettings(id, p.DivisionId, p.SiteId);
            if (temp != null)
            {
                p.DocTypeId = id;
            ...
            p.SaleOrderSettings = Mapper.Map<SaleOrderSettings, SaleOrderSettingsViewModel>(temp);
            ViewBag.Mode = "Add";
