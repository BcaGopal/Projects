...
namespace Service
{
    ...
    public class JobReceiveQALineService : IJobReceiveQALineService
    {
        ...
        public JobReceiveQALine Create(JobReceiveQALine pt, string UserName)
        {
            ...
            //              where H.JobReceiveQAHeaderId == pt.JobReceiveQAHeaderId
            //              select new
            //              {
            ...
            ////Posting in Stock
            //if (Settings.isPostedInStock ?? false && pt.FailQty > 0)
            //{
            ...
            //                                 where L.JobReceiveLineId == pt.JobReceiveLineId
            ...
            //    StockViewModel_IssQty.DocLineId = pt.JobReceiveLineId;
            ...
            //    StockViewModel_IssQty.PersonId = Header.JobWorkerId;
            ...
            //    StockViewModel_IssQty.Qty_Iss = pt.QAQty;
            ...
            //    StockViewModel_RecFailedQty.DocLineId = pt.JobReceiveLineId;
            ...
            //    StockViewModel_RecFailedQty.Qty_Rec = pt.FailQty;
            ...
            //    StockViewModel_RecPassedQty.DocLineId = pt.JobReceiveLineId;
            ...
            //    StockViewModel_RecPassedQty.Qty_Rec = pt.QAQty - pt.FailQty;
            ...
            //    {
            //        throw new Exception(StockPostingError);
            //    }


            //    //if (Header.StockHeaderId == null)
            //    //{
            //    //    Header.StockHeaderId = StockViewModel_IssQty.StockHeaderId;
            //    //}
            //}
        ...
        public int? StockPost(int JobReceiveQAHeaderId)
        {
            ...
            //                                where L.StockHeaderId == Header.StockHeaderId
            //                                select L).ToList();

            //foreach (var stockdet in StockList)
            //{
            //    db.Stock.Remove(stockdet);
            //}
